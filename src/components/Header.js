      ...
      <div className="container">
        <div className="header-content">
          ...
          <div className="header-actions">
            ...
            <a href="https://docs.google.com/forms/d/1TfOOKB2NfErY2DAALDHZEL9XfHyeTiDpbBSlDIp5tL0/viewform" className="cta-button cta-button--nav" target="_blank" rel="noopener noreferrer" style={{ padding: '10px 20px' }}>Book a Session</a>
